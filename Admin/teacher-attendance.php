...
<html lang="en">
	<head>
		<title>المشرف - حضور المدرب</title>
	</head>
	<body>
							...
							<div class="row mt-3">
								<div class="col-md-6">
									<div class="form-group">
										<label>ادخل رقم المدرب:</label>
										<div class="d-flex">
											<input type="text" class="form-control" name="teacher_id" placeholder="ادخل رقم المدرب">

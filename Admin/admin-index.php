					...
					<div>
						<section class="mt-3">
							<div class="btn btn-block table-one text-light d-flex">
								<span class="font-weight-bold"><i class="fa fa-clock-o mr-2" aria-hidden="true"></i> الجدول الزمني</span>
					...
					<div>
						<section class="mt-4">
							<div class="btn btn-block table-three text-light d-flex">
								<span class="font-weight-bold"><i class="fa fa-asterisk mr-2" aria-hidden="true"></i> تفاصيل موضوع القسم</span>

							...
							<div class="row mt-3">
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputEmail1">حدد اللغة:</label>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>ادخل رقم الطالب:</label>
										<input type="text" name="roll_no" class="form-control" placeholder="ادخل رقم الطالب">
									</div>
								</div>
								<div class="col-md-4">

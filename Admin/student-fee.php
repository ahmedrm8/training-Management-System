...
<html lang="en">
	<head>
		<title>المشرف - رسوم الطالب</title>
	</head>
	<body>
							...
							<div class="row mt-3">
								<div class="col-md-6">
									<div class="form-group">
										<label>أدخل رول نo:</label>
										<div class="d-flex">
											<input type="text" class="form-control" name="roll_no" placeholder="أدخل رول ن">

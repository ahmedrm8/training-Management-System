...
<html lang="en">
	<head>
		<title>المشرف - راتب المدرب</title>
	</head>
	<body>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 w-100">
			<div class="sub-main">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<div class="d-flex">
						<h4 class="mr-5">نظام إدارة رواتب المدربين </h4>
						<button type="button" class="btn btn-primary ml-5 mr-5" data-toggle="modal" data-target=".bd-example-modal-lg">إضافة سلم الرواتب</button>
						<button type="button" class="btn btn-primary ml-5" data-toggle="modal" data-target=".add_salary">أضف الراتب</button>
					</div>
				</div>
				<div class="row">
										...
										<div class="modal-dialog modal-lg">
												<div class="modal-content">
													<div class="modal-header bg-info text-white">
														<h4 class="modal-title text-center">أضف الراتب</h4>
													</div>
													<div class="modal-body">
														<form action="teacher-salary.php" method="post">
															<div class="row mt-3">
																<div class="col-md-6 pr-5">
																	<div class="form-group">
																		...
																		<input type="text" name="teacher_id" class="form-control" placeholder="ادخل رقم المدرب">
																	</div>
																</div>
																<div class="col-md-6 pr-5">
																	<div class="form-group">
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="exampleInputEmail1">بدل الطبي: </label>
																		<input type="text" name="medical_allowance" class="form-control" placeholder="ادخل البدل">
																	</div>
																</div>
																<div class="col-md-6">
																	<div class="formp">
																		<label for="exampleInputEmail1">بدل إيجار المنزل: </label>
																		<input type="text" name="hr_allowance" class="form-control" placeholder="ادخل بدل إيجار المنزل ">
																	</div>
																</div>
															</div>
															<div class="row">
																<div class="col-md-6">
																	<div class="formp">
																		<label for="exampleInputEmail1">مقياس مدفوع الأجر: </label>
																		<input type="text" name="scale" class="form-control"placeholder="ادخل مقياس مدفوع الأجر">
																	</div>
																</div>
															</div>
															<div class="modal-footer">
																<input type="submit" class="btn btn-primary" name="btn_save" value="احفظ">
														...
														<form action="teacher-salary.php" method="post">
															<div class="row mt-3">
																<div class="col-md-12 pr-5">
																	<div class="form-group">
																		<label for="exampleInputEmail1">رقم المدرب: </label>
																		<input type="text" name="teacher_id" class="form-control" placeholder="ادخل رقم المدرب">
																	</div>
																</div>
															</div>
								...
								<div class="col-md-12">
									<table class="w-100 table-elements table-three-tr" cellpadding="3">
										<tr class="table-tr-head table-three text-white">
											<td colspan="9" class=" text-center text-white"><h4>تقرير رواتب جميع المدربين</h4></td>
										</tr>
										<tr class="table-tr-head">
											...
											<th>راتب اساسي</th>
											<th>بدل الطبي</th>
											<th>بدل الموارد البشرية</th>
											<th>جدول الأجور</th>
											<th>تاريخ المدفوعة</th>

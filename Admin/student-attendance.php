...
<html lang="en">
	<head>
		<title>المشرف - حضور الطلاب</title>
	</head>
	<body>
							...
							<table class="w-100 table-elements table-three-tr" cellpadding="3">
								...
								$count=0;
									...
									?>
										...
										<?php 	}
											?>
											<td>Present<input type="checkbox" name="attendance[]" value="1">غائب<input type="checkbox" name="attendance[]" value="0" ></td>

...
<html lang="en">
	<head>
		<title>المشرف - إدارة الحسابات</title>
	</head>
	<body>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				<div class="bar-margin text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4>نظام إدارة حسابات المستخدمين </h4>
				</div>
				<div class="row">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12">
								<form action="manage-accounts.php" method="post">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label>أدخل معرف المستخدم</label>
												<input type="text" name="user_id" class="form-control" required placeholder="أدخل معرف المستخدم">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>أدخل حالة الحساب:</label>
												<select name="account" class="form-control">
													<option>أدخل حالة الحساب</option>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<input type="submit" name="submit" value="تغير" class="btn btn-primary px-5">
											</div>
										</div>
									</div>
								</form>

...
<?php include "../common/common-header.php"?>
    <div class="container mt-4">
        <div class="text-danger text-center m-auto">
            ...
            <h4 class="text-dark mt-3">التدريب   الكورسات - *</h4>
            <h4 class="text-dark">flutter</h4>
        </div>
    </div>
        ...
        <div class="program-info">
            <?php  
                ...
                while($row = mysqli_fetch_array($run)){ ?>
                    <h5>نسخة الطالب - <?php echo $row['course_code']; ?> برنامج</h5>
        </div>
        <div class="d-flex mt-3">
            <div>
                <h5>أسم الطالب : <?php echo $row['first_name']. " ". $row['middle_name']. " ". $row['last_name']; ?></h5>
                <h5>لذا : <?php echo $row['father_name']; ?></h5>
            </div>
            <div class="ml-auto">
                <h5>هوية الطالب # : <?php echo $row['roll_no']; ?></h5>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <tr>
                                    <th colspan="4">نصف الجي بي اي</th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">النصف الاخر</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>CH</th>
                                    <th>%</th>
                                    <th>G.P</th>
                                    <th>Letter</th>
                                ...
                                ?>
                                <tr>
                                    <th colspan="2">إجمالي الفصل الاخر CH</th>
                                    <?php $total_semester_ch = $total_semester_ch + $total_ch; ?>
                                    <th><?php echo $total_ch; ?></th>
                                    <th></th>
                                    <th></th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">نصف الاخير - 4</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>CH</th>
                                    <th>%</th>
                                    <th>G.P</th>
                                    <th>Letter</th>
                                ...
                                ?>
                                <tr>
                                    <th colspan="2">إجمالي الفصل الاخير CH</th>
                                    <?php $total_semester_ch = $total_semester_ch + $total_ch; ?>
                                    <th><?php echo $total_ch; ?></th>
                                    <th></th>
                                    <th></th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                <tr>
                                    <th colspan="2">اجمالي الفل الثاني</th>
                                    <?php $total_semester_ch = $total_semester_ch + $total_ch; ?>
                                    <th><?php echo $total_ch; ?></th>
                                    <th></th>
                                    <th></th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">نصف الاخير - 7</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>CH</th>
                                    <th>%</th>
                                    <th>G.P</th>
                                    <th>Letter</th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">نصف - 8</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>الفصل</th>
                                    <th>%</th>
                                    <th>جي بي اي</th>
                                    <th>خطاب</th>
                                ...
                                ?>
                                <tr>
                                    <th colspan="2">المجموع الكلي للفصل  </th>
                                    <?php $total_semester_ch = $total_semester_ch + $total_ch; ?>
                                    <th><?php echo $total_ch; ?></th>
                                    <th></th>
                                    <th></th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <tr>
                                    <th colspan="2">إجمالي CH للتخرج</th>
                                ...
                                <tr>
                                    <th colspan="4">المعدل الفصلي</th>
                                    <?php $all_semester_quality_points = $all_semester_quality_points + $total_quality_points; ?>
                                    <th colspan="2"><?php echo  round($total_quality_points/$total_ch, 2); ?></th>
                                </tr>
                                </tr>
                                    <th colspan="4">المعدل التراكمي للفصل الاخير</th>
    ...
    <div class="container-fluid">
        <div class="row text-center font-weight-bold mb-5">
            <div class="col-xl-4">أُعدت بواسطة</div>
            <div class="col-xl-4">عميد</div>
            <div class="col-xl-4">فحوصات المراقب المالي</div>
        </div>
    </div>

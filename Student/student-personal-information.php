...
<html lang="en">
	<head>
		<title>المعلومات الشخصية للطالب</title>
	</head>
	<body>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 w-100">
			<div class="sub-main sub-main-student">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4 class="">قم بتحديث معلوماتك الشخصية </h4>
				</div>
				<div class="row ml-4">
						...
						<form action="student-personal-information.php" method="post">
							...
							<div class="row">
								...
								<div class="col-md-6 pr-5">
									<div class="form-group">
										<label for="exampleInputPassword1">الاسم الأوسط:*</label>
							...
							<div class="row">
								...
								<div class="col-md-6 pr-5">
									<div class="form-group">
										<label for="exampleInputPassword1">اسم الأب:*</label>
							...
							<div class="row">
								...
								<div class="col-md-6 pr-5">
									<div class="form-group">
										...
										<input type="number" name="semester" class="form-control"  placeholder="نصف الكورس" value=<?php echo $row['semester'] ?>>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 pr-5">
									<div class="form-group">
										<label for="exampleInputEmail1">إجمالي العلامات (العلامات المتوسطة/HSSC/المكافئة):*</label>
										<input type="number" name="total_marks" class="form-control" placeholder="العلامات" value=<?php echo $row['total_marks'] ?>>
									</div>
								</div>
								<div class="col-md-6 pr-5">
									<div class="form-group">
										<label for="exampleInputPassword1">الحصول على العلامات (العلامات المتوسطة/HSSC/المكافئة):*</label>
										<input type="number" name="obtain_marks" class="form-control"  placeholder="العلامات" value=<?php echo $row['obtain_marks'] ?>>
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-md-6 pr-5">
									<div class="form-group">
										<label for="exampleInputPassword1">العنوان الثابت:*</label>
							...
							<div class="row">
								<div class="col-md-6 pr-5">
									<div class="form-group">
										<label for="exampleInputEmail1">الولاية أو المقاطعة: *</label>
										<input type="text" name="state" class="form-control" placeholder="الولاية أو المقاطعة" value=<?php echo $row['state'] ?>>
									</div>
								</div>
								<div class="col-md-6 pr-5">
									<div class="form-group">
							...
							<div class="row mt-3">
								<div class="col-lg-6 col-md-6 offset-4">
									<input type="submit" name="sub" type="submit" class="btn btn-primary" value="تحديث المعلومات">
								</div>
							</div>
						</form>
					</div>

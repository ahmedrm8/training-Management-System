	...
	<body class="login-background">
        ...
        <div class="login-div mt-3 rounded">
            ...
            <div class="login-padding">
                <h2 class="text-center text-white">تسجيل دخول</h2>
                <form class="p-1" action="login.php" method="POST">
                    <div class="form-group">
                        <label><h6>:أدخل رقم الهوية/البريد الإلكتروني الخاص بك</h6></label>
                        <input type="text" name="email" placeholder="أدخل معرف المستخدم" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label><h6>:أدخل كلمة المرور</h6></label>
                        <input type="Password" name="password" placeholder="أدخل كلمة المرور" class="form-control border-bottom" required>
                        <!-- <?php echo $message; ?> -->
                    </div>
                    <div class="form-group text-center mb-3 mt-4">
                        <input type="submit" name="btnlogin" value="سجل دخول " class="btn btn-white pl-5 pr-5 ">
                    </div>
                </form>
            </div>
        </div>

			...
			<div class="col-xl-12 col-lg-12 col-md-12 w-100">
				<div class="bg-info text-center">
					<div class="table-one flex-wrap flex-md-no-wrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
						<h4>نموذج القبول عبر الإنترنت</h4>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-md-12">
				<form action="student.php" method="POST" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								<label for="exampleInputPassword1">حدد الدورة التدريبية:</label>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="file" name="profile_image" placeholder="عمر الطالب" class="form-control">
							</div>
						</div>
					</div>
					<div class="row">

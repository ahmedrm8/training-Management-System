...
<html lang="en">
	<head>
		<title>المدرب - لوحة القيادة</title>
	</head>
	<body>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 main-background mb-2 w-100">
			<div class="sub-main">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4 class="">مرحبا بك في <?php $roll_no=$_SESSION['LoginTeacher'];
						...
						<div>
							<section class="mt-3">
								<div class="btn btn-block table-one text-light d-flex">
									<span class="font-weight-bold"><i class="fa fa-bell-o mr-3" aria-hidden="true"></i> إشعارات</span>
				...
				<div class="row">
					<div class="col-md-12 mt-4">
						<table class="w-100 table-striped table-hover table-dark"cellpadding="2" >
							<tr>
								<td colspan="12" class="text-center text-white"><h5>تقرير الحضور</h5></td>
							</tr>
							<tr>
								<th>شهر</th>
								<th>أيام العمل</th>
